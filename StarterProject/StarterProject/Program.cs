...
var clientAssembly = typeof(StarterProject.Client._Imports).Assembly;
var thisAssembly = typeof(ExceptionMiddleware).Assembly;
...
app.UseMiddleware<HybridRequestLocalizationMiddleware>();
